	...
	if( !isset( $edit ) && !isset( $ID ) ){
	  ...
	  <div id="rsjpRightCol">
          <script language="javascript">
		      function exportSubToPDF(){
				  <?php echo exportSubToPDF( $ID ); ?>
			  }
		  </script>
		  <?php 
					  ...
					  <td>
						  ...
						  <table cellpadding="2" cellspacing="2">
							  <tr>
								  ...
								  <td><input type="image" name="subToPDF" src="<?php echo resume_get_plugin_dir( 'go' ); ?>/images/icons/pdf-icon.png" onclick="exportSubToPDF()" alt="Download to PDF" title="Download to PDF" /></td>
							  </tr>
						  </table>
					  </td>
				  </tr>
